...
function AppHeader(): ReactElement {
    return (
        <div className="border-b border-border-subtle h-20 flex justify-center w-full mx-auto">
            <div className="flex items-center p-10 max-w-[1440px] grow h-full justify-between">
                <NavLogo />
                <Suspense>
                    <LoggedInUser />
                </Suspense>
